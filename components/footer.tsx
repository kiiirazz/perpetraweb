const PRODUCT_LINKS = [
  { label: "Trade", href: "https://perpetra.xyz" },
  { label: "Documentation", href: "https://docs.perpetra.xyz" },
  { label: "Fees", href: "https://docs.perpetra.xyz/reference/fees" },
  { label: "Markets", href: "https://docs.perpetra.xyz/reference/markets" },
] as const;

const COMMUNITY_LINKS = [
  { label: "X (Twitter)", href: "https://x.com/perpetra" },
  { label: "Discord", href: "https://discord.gg/perpetra" },
  { label: "GitHub", href: "https://github.com/perpetra" },
] as const;
      ...
      <div className="mx-auto max-w-7xl px-6 pt-14 pb-8">
        ...
        <div className="mt-14 pt-6 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            ...
            {/* Discord */}
            <a
              href="https://discord.gg/perpetra"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Discord"
              className="text-gray-600 hover:text-gray-400 transition-colors"
            ...
            {/* GitHub */}
            <a
              href="https://github.com/perpetra"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="text-gray-600 hover:text-gray-400 transition-colors"
